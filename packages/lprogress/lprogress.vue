<template>
<div :class="progclass"  v-show="props.circle==false"><div :class="intext" v-if="props.hidetext==false">{{ percent }}%<slot></slot></div></div>
<div v-show="props.circle==true" :class="cirlcess">
<div class="left"> <div ref="ileft" :class="itemleftclass" ></div></div>
<div class="right"><div ref="iright" :class="itemrightclass" ></div></div>
