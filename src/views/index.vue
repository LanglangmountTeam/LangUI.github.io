<template>
	<div class="index-nav">
		<div class="index-nav-module">
			<div class="index-nav-img" @click="index">
				...
				<p style="margin-left: 0.5vw;line-height: 4vh;">LANG-UI</p>
			</div>
	...
	<div><p>一个采用了vue3+Typescript封装的组件库,致力于实现更好的体验</p></div>
    </div>
	...
	<div class="threecol">
		...
		<div class="three-one">
			...
			<p style="margin-top: 2vh;">基于vue3</p>
		</div>
		<div class="three-one">
			...
			<p style="margin-top: 2vh;">TypeScript</p>
		</div>
	</div>
</template>
